...
export const siteConfig: SiteConfig = {
	title: "zhang-h-h",
	subtitle: "个人站",
	siteURL: "https://sttez-blog.vercel.app//", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2024-01-05", // 站点开始运行日期，用于站点统计组件计算运行天数
...
export const commentConfig: CommentConfig = {
	...
	twikoo: {
		envId: "https://zhh-blogcomment.netlify.app",
		lang: SITE_LANG,
	},
};
...
export const footerConfig: FooterConfig = {
	...
	customHtml: "你好，欢迎阅读！", // HTML格式的自定义页脚信息，例如备案号等，默认留空
