...
### 吉林艾优数字科技有限公司　|　用户行为分析与智能决策系统

`2024.08 - 2024.09`

- 参与企业用户行为分析平台开发，基于 PySpark + Spark MLlib 对海量业务数据进行清洗、统计分析与特征建模
- 实现用户行为识别、活跃度分析及个性化推荐功能
- 参与智能设备时序数据分析模块开发，通过机器学习模型对设备使用行为进行识别与异常检测

### 新疆文晟公司　|　AI 开发工程师

`2026.03 - 2026.04`

- 基于 Ollama + DeepSeek + AnythingLLM 搭建企业内部离线 AI 知识库，参与本地大模型部署、语义检索与 RAG 问答流程实现
- 基于 Spring Boot 3 + Vue 3 开发企业 OA 管理系统，参与用户权限、审批流程、公告管理等模块开发
- 使用 MyBatis-Plus、Redis 实现业务功能与数据优化，熟练使用 Cursor、Claude Code、DeepSeek 等 AI 工具辅助开发
